...
import nishkaaminnovations.com.likhosmart.databinding.FragmentSmartpointsBinding

class smartpoints : Fragment() {

    /*
    Variable to represent the binding.
     */
    private lateinit var binding:FragmentSmartpointsBinding
    ...
    override fun onCreateView(
        ...
        binding=FragmentSmartpointsBinding.inflate(inflater,container,false)
        ...
        binding.backtodocprofilebutton.setOnClickListener{
